...
<div class="box box-primary">
	...
	<form role="form">
		<div class="box-body">
			...
			<div class="form-group">
				<?php echo $this->Form->input('role', array('class' => 'form-control', 'options' => array('invitado' => 'Invitado', 'visitante' => 'Visitante', 'admin' => 'Admin')));?>
			</div>
		</div>
		...
		<div class="box-footer">
			...
			<br>
			<?php echo $this->Html->link( "Salirse",   array('action'=>'logout') ); ?>
			<br>
