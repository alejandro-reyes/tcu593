                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="/tcu/users/logout/" class="btn btn-default btn-flat">Salir</a>
                                    </div>
									<?php } else{ ?>
									<div class="pull-left">
                                        <a href="/tcu/users/login/" class="btn btn-default btn-flat">Entrar</a>
                                    </div>
									<div class="pull-right">
                                        <a href="/tcu/users/add/" class="btn btn-default btn-flat">Registrarse</a>
                                    </div>
									<?php } ?>
                                </li>
                            </ul>
